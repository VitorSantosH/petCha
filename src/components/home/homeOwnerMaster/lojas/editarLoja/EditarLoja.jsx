            ...
            <div className="dadosDaLoja">
                ...
                <div className="storeDadosEditarLoja">
                    ...
                    <div className="nameStore">
                        ...
                        <input
                            defaultValue={`${state.store.companyData.name}`}
                        />
                    </div>
                    ...
                    <div className="cnpj">
                        ...
                        <span>
                            ...
                            <NumberFormat format="##.###.###/####-##" value={state.store.companyData.cnpj} />
                        </span>
                    </div>
                    ...
                    <div className="razaoSocial">
                        ...
                        <input
                            defaultValue={state.store.companyData.razaoSocial}
                        />
                    </div>
                    ...
                    <div className="cep">
                        ...
                        <span>
                            <NumberFormat format="######-##" value={state.store.addressData.postalCode} />
                        </span>
                    ...
                    <div className="rua">
                        ...
                        <input
                            defaultValue={`${state.store.addressData.street}`}
                        />
                    ...
                    <div className="numero">
                        ...
                        <input
                            defaultValue={` ${state.store.addressData.streetNumber}`}
                        />
                ...
                <div className="storeDadosEditarLoja">
                    ...
                    <div className="bairro">
                        ...
                        <input
                            defaultValue={`${state.store.addressData.district}`}
                        />
                    ...
                    <div className="complemento">
                        ...
                        <input
                            defaultValue={state.store.addressData.complement ?
                    ...
                    <div className="estado">
                        ...
                        <input
                            defaultValue={state.store.addressData.txtState}
                        />
                    </div>
                    ...
                    <div className="cidade">
                        ...
                        <input
                            defaultValue={state.store.addressData.city}
                        />
                    </div>
                    <div className="tel">
                        <label htmlFor="">Telefone da loja{" "}</label>
                        <NumberFormat format="##-#########" value={state.store.phones[0].fullNumber} />
                    </div>
